	            ...
	            <nav class="navbar navbar-expand-lg navbar-light bg-light py-lg-4 pt-2 ">
	               ...
	               <div class="collapse navbar-collapse justify-content-end m-4 m-lg-0" id="whale-nav">
	                  <ul class="navbar-nav justify-content-lg-end text-center text-lg-left mr-1 w-100">  
	                     	...
	                     	<ul class="dropdown-menu inner-submenu" aria-labelledby="navbarDropdownMenuLink">
	                     	    ...
	                     	    <div class="dropdown-divider" class="dropdown-item"></div>
	                     	     <li  class="dropdown-submenu"><a href="#" class="dropdown-item dropdown-toggle mobile-toggle"  >Digital Marketing</a>
	                     	    	...
	                     	    	<ul class="dropdown-menu inner-submenu">
	                     	    		...
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/services/digital-marketing/">Paid Social</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/services/digital-marketing/">Paid Search</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/services/digital-marketing/">Email</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/services/digital-marketing/">Local Ads</a></li> 
	                     	    		<!-- <div class="dropdown-divider"></div>
	                     	    ...
	                     	    <li class="dropdown-submenu">
	                     	    	...
	                     	    	<ul class="dropdown-menu inner-submenu">
	                     	    		...
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/servicesweb-design-development/">Websites</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/servicesweb-design-development/">Landing Pages</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    ...
	                     	    <li class="dropdown-submenu"><a href="<?php echo site_url(); ?>/services/creative-and-copy/" class="dropdown-item dropdown-toggle mobile-toggle">Creative and Copy</a>
	                     	    	...
	                     	    	<ul class="dropdown-menu inner-submenu">
	                     	    		...
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/creative-and-copy/">Content Writing</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                     	    		<li><a class="dropdown-item" href="<?php echo site_url(); ?>/creative-and-copy/">Ad Creatives</a></li>
	                     	    		<div class="dropdown-divider"></div>
	                   ...
	                   <a href="<?php echo site_url();?>/hire" class="talk-btn"> Get In Touch  </a>  
	               </div>
	            </nav>
	                        ...
	                        <div id="mobileNav" class="mobileOverlay">
	                          ...
	                          <nav class="nav-mobile" id="mobileNavInner">
	                          	...
	                          	<div class="mobile-logo-div mb-5">
	                          		<img src="<?php echo get_template_directory_uri();?>/images/logo.png" alt="" class="imgfluid">
	                          	</div>
	                          	<ul class="navbar-nav">
	                          		<li class="nav-item">
	                          			...
	                          			<ul id="services-nav" class="collapse first-level-dropdown have-border have-transition">
	                          				...
	                          				<li class="nav-item">
	                          					...
	                          					Digital Marketing
	            		              				...
	            		              				<ul class="  second-level-dropdown collapse have-border have-transition"  id="dm-nav">
	            		              					...
	            		              					<li class="nav-item">
	            		              						<a href="<?php echo site_url(); ?>/services/digital-marketing/" class="nav-link">
	            		              						Paid Social
	            		              					</a>
	            		              						
	            		              					</li> 
	            		              					<li class="nav-item"><a href="<?php echo site_url(); ?>/services/digital-marketing/" class="nav-link">
	            		              						Paid Search
	            		              					</a>
	                          				...
	                          				<li class="nav-item">
	                          					...
	                          					<ul class=" second-level-dropdown collapse have-border have-transition"  id="web-nav">
	                          						...
	                          						<li class="nav-item"><a href="<?php echo site_url(); ?>/services/web-design-development/" class="nav-link">
	                          							Websites 
	                          						</a>
	                          				...
	                          				<li class="nav-item">
	                          					...
	                          					<ul class=" second-level-dropdown collapse have-border have-transition"  id="creative-nav">
	                          						...
	                          						<li class="nav-item"><a href="<?php echo site_url(); ?>/services/creative-and-copy/" class="nav-link">
	                          							Content Writing
	                          						</a>
	                          		...
	                          		<li class="nav-item">
	                          			<a href="<?php echo site_url();?>/contact-us" class="nav-link <?php if (is_page('contact-us')) echo 'active';?>">Contact</a>
	                          		</li>
	                          	</ul>
